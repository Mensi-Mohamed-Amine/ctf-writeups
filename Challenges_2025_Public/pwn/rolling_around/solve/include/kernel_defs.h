...
#define MAP_OPS_PUSH_ELEM_OFFSET    0x78

// Offset of id field in btf struct
#define BTF_ID_OFFSET 0x58

// Offset of tasks field in pid structure
#define PID_TASKS_OFFSET 0x38


//Alternatively this might be the `sibling` field?
// Offset of linked list entry in task_struct
#define TASK_LIST_OFFSET 0x600


//this is the offset to `real_cred`, `cred` is 8bytes after
#define TASK_CRED_OFFSET 0x760


// Offset of uid field in cred structure
#define CRED_UID_OFFSET  0x8
// Offset of gid field in cred structure
#define CRED_GID_OFFSET  0xC
// Offset of euid field in cred structure
#define CRED_EUID_OFFSET 0x18
...
//TODO this struct has extra fields
struct xa_node 
{
...
//TODO this struct also has extra fields
